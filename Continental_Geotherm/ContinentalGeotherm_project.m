...
M.H         =   -100;           %   Modeltiefe [ in km ]
M.xmax      =   1;              %   Seitenverhaeltniss

M.zUC       =   -25e3;          % Depth of the upper crust
...
Py.k0       =   3.0;                %   Thermische Leitfaehigkeit [ W/m/K ]
Py.Q0       =   0*Py.rho0;          %   Heat productino rate per mass [ W/kg ]

% Constants for the upper crust ------------------------
Py.rhoUC    =   2700;               %   [ kg/m^3 ]
Py.kUC      =   2.5;                %   [ W/m/K ]
Py.QUC      =   5.1852e-10*Py.rhoUC;%   [ W/kg ]

% Constant for the lower crust -------------------------
Py.rhoLC    =   2900;               %   [ kg/m^3 ]
Py.kLC      =   2.1;                %   [ W/m/K ]
Py.QLC      =   1.3793e-10*Py.rhoLC;    %   [ W/kg ]
...
B.bhf       =   Py.Tbot + 273.15;% 0.04;     [ W/m^2 ]
% ======================================================================= %
%% ----------------------- Felddefinitionen ----------------------------- %
