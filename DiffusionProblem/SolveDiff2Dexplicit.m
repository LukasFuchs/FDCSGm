function [T1] = SolveDiff2Dexplicit(T0,Q,rho,dt,P,N,B)
...
T1(ind1,ind2) = T0(ind1,ind2) + ...
    ...
    Q(ind1,ind2)*dt./rho(ind1,ind2)./P.cp;
...
switch B.rtbc
    ...
    case {'flux','neumann'}
        T1(ind1,N.nx) = T0(ind1,N.nx) + ...
            ...
            sz.*(T0((ind1)+1,1) - 2.*T0(ind1,1) + T0((ind1)-1,1)) + ...
            Q(ind1,N.nx)*dt./rho(ind1,N.nx)./P.cp;
end
end