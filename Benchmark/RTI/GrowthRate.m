...
lambda          =   [1 1.5 2 2.5 3 3.5 4 4.5 5 5.5 6].*1e3;   % [ m ]
...
%% Analytical solution ================================================== %
lambda_ana      =   linspace(0.5,6,51).*1e3;
...
for k = 1:length(delfac)
    for i = 1:length(etar)
        ...
        for j = 1:length(lambda)
            ...
            PP.zn           =   double(int16(floor(PP.zwave./N.dz)))+1;
            ...
            %                         plot(M.X(PP.zn,PP.xn)/1e3,M.Z(PP.zn,PP.xn)/1e3,'k.',...
            %                             M.X(PP.zn,PP.xn+1)/1e3,M.Z(PP.zn,PP.xn+1)/1e3,'k.',...
            %                             M.X(PP.zn+1,PP.xn)/1e3,M.Z(PP.zn+1,PP.xn)/1e3,'k.',...
            %                             M.X(PP.zn+1,PP.xn+1)/1e3,M.Z(PP.zn+1,PP.xn+1)/1e3,'k.')
            %                         ind     =   Ma.XM >= (PP.xwave-100) & ...
            %                             Ma.XM <= (PP.xwave+100) & ...
            %                             Ma.ZM >= (M.H/2+0.1*M.H) & ...
            %                             Ma.ZM <= (M.H/2-0.1*M.H) & Ma.C==2;
            %                         scatter(Ma.XM(ind)./1e3,Ma.ZM(ind)./1e3,8,Ma.C(ind),'filled')
            %                         plot(Ma.xm/1e3,Ma.deltaAm/1e3+M.H/1e3/2,'-')
